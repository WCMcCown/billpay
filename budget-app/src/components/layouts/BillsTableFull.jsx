 ...
 * BillsTableFull
 * --------------
 * Full-detail table layout for bills.
 * This is the "power user" view — all columns visible.
 *
 * Features:
        ...
        {bills.map((b) => {
          ...
          return (
            <tr key={b.id}>
              ...
              <td>{isDebt ? money(payoff.totalInterest) : ""}</td>

              <td>
                {isDebt ? money(interestPerPeriod(b.apr, b.remaining)) : ""}
              </td>

              <td>
                {isDebt ? money(interestPerYear(b.apr, b.remaining)) : ""}
              </td>
              ...
              <td>
                {b.notes ? (
                  <span title={b.notes} style={{ cursor: "help" }}>
                    📝
                  </span>
                ) : (
                  ""
